...
// Component Interface: defines a common interface for Mario and all power-up
// decorators
class Character {
public:
...
int main() {
  ...
  // Decorator Mario with a HeightUp Power-Up.
  mario = new HeightUp(mario);
  cout << "After HeightUp: " << mario->getAbilities() << endl;

  // Decorator Mario further with a GunPowerUp.
