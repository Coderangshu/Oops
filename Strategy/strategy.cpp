...
public:
  void talk() override { cout << "Talking normally." << endl; }
};

class NoTalk : public TalkableRobot {
public:
  void talk() override { cout << "Cannot talk." << endl; }
};
...
public:
  void fly() override { cout << "Flying normally." << endl; }
};

class NoFly : public FlyableRobot {
public:
  void fly() override { cout << "Cannot fly." << endl; }
};
...
public:
  ...
  void walk() { walkBehaviour->walk(); }

  void talk() { talkBehaviour->talk(); }
